    ...
    <div className="relative min-h-screen pt-32 pb-40 px-6 overflow-hidden animate-pulse">
      <div className="container mx-auto max-w-7xl relative z-10">
        <header className="flex flex-col md:flex-row gap-12 items-center md:items-start mb-24">
          <div className="w-40 h-40 rounded-full bg-white/[0.03] border border-white/[0.06]" />
          <div className="flex-1 space-y-6 text-center md:text-left">
            <div className="flex flex-wrap items-center justify-center md:justify-start gap-6 mb-6">
              ...
              <div className="h-8 w-32 bg-white/[0.03] rounded-full border border-white/[0.04]" />
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          <div className="lg:col-span-2 space-y-10">
            ...
            <div className="dev-surface overflow-hidden rounded-2xl">
              <div className="h-16 bg-white/[0.03] border-b border-white/[0.04]" />
              {[...Array(6)].map((_, i) => (
                <div key={i} className="h-24 border-b border-white/[0.04] flex items-center px-10 gap-12">
          ...
          <div className="space-y-10">
            ...
            <div className="dev-surface p-10 h-[500px] flex flex-col gap-10 rounded-2xl">
              {[...Array(6)].map((_, i) => (
