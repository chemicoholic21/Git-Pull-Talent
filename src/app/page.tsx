        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <form onSubmit={handleSearch} className="relative max-w-lg mx-auto mb-8">
              ...
              <button
                type="submit"
                className="absolute right-2 top-2 bottom-2 bg-green-500 hover:bg-green-400 text-gray-950 font-bold px-6 rounded transition-colors shadow-lg shadow-green-500/20"
              >
                Analyze
              </button>
            </form>
